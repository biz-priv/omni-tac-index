async function cwQuery() {
    ...
    main.actl_wght as "actual weight",
    case when (case when main.chrg_wght <= 0 then main.actl_wght else main.chrg_wght end ) < main.actl_wght then main.actl_wght else main.chrg_wght end as "chargeable weight",
    ...
    --case when jw_atd = '1900-01-01 00:00:00.000' then jw_etd end atd,
