...
const { cwQuery } = require("../omni-tac-index-ecr/shared/query/cw_Query")
const { wtQuery } = require("../omni-tac-index-ecr/shared/query/wt_Query")
